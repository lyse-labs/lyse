...
const DISCLAIMER_PHRASES: RegExp[] = [
  ...
  /\bverify\s+(?:results|the\s+output)\b/i,
];
...
export const rule: Rule = createLyseRule({
  meta: {
    ...
    fullDescription:
      ...
      "`Check important info`, `Powered by AI`, `AI-assisted`, `Uses AI. Verify results.`, `verify results`, `verify the output`, case-insensitive word-boundary) or a " +
