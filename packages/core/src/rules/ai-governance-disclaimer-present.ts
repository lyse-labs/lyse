  ...
  for (const rel of componentFiles) {
    ...
    if (hasMarker && !disclaimer.found) {
      findings.push({
        ...
        message:
          `AI-marker component detected in ${rel} but no disclaimer text or disclaimer component found nearby. ` +
          `Add a disclaimer (e.g. "Generated by AI", "May be inaccurate") or an AIDisclaimer/Disclaimer component ` +
          `to meet capability-framing requirements (HAX G1/G2 — GitLab Pajamas).`,
        suggestion:
